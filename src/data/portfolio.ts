...
export const PORTFOLIO_ITEMS: PortfolioItem[] = [
  ...
  {
    slug: "gyeonggi-hwaseong-dongtan-geumgang-penterium-bathroom",
    apartment: "동탄 금강 펜테리움",
    region: "경기",
    district: "화성시",
    area: 34,
    space: "화장실",
    spaceDetail: "바닥",
    material: "케라폭시",
    materialDetail: "112번 미디엄 그레이",
    duration: "1일",
    date: "2026-06-19",
    asPeriod: '2년',
    images: [
      { src: "/portfolio/gyeonggi-hwaseong-dongtan-geumgang-penterium-bathroom/before_01.webp", alt: "경기 화성시 동탄 금강 펜테리움 화장실 줄눈 시공 전 상태 01", type: "before" },
      { src: "/portfolio/gyeonggi-hwaseong-dongtan-geumgang-penterium-bathroom/before_02.webp", alt: "경기 화성시 동탄 금강 펜테리움 화장실 줄눈 시공 전 상태 02", type: "before" },
      { src: "/portfolio/gyeonggi-hwaseong-dongtan-geumgang-penterium-bathroom/before_03.webp", alt: "경기 화성시 동탄 금강 펜테리움 화장실 줄눈 시공 전 상태 03", type: "before" },
      { src: "/portfolio/gyeonggi-hwaseong-dongtan-geumgang-penterium-bathroom/after-main.webp", alt: "경기 화성시 동탄 금강 펜테리움 화장실 케라폭시 줄눈시공 시공 후 대표", type: "after-main" },
      { src: "/portfolio/gyeonggi-hwaseong-dongtan-geumgang-penterium-bathroom/after_01.webp", alt: "동탄 금강 펜테리움 화장실 케라폭시 줄눈 마감 디테일 01", type: "after" },
      { src: "/portfolio/gyeonggi-hwaseong-dongtan-geumgang-penterium-bathroom/after_02.webp", alt: "동탄 금강 펜테리움 화장실 케라폭시 줄눈 마감 디테일 02", type: "after" },
      { src: "/portfolio/gyeonggi-hwaseong-dongtan-geumgang-penterium-bathroom/after_03.webp", alt: "동탄 금강 펜테리움 화장실 케라폭시 줄눈 마감 디테일 03", type: "after" },
    ],
    title: "동탄 금강 펜테리움 화장실 케라폭시 줄눈시공 사례 | 디테일라인",
    description: "동탄 금강 펜테리움 34평 아파트 화장실에 구멍 난 줄눈과 덜그럭거리는 타일을 보수하고, 그레이톤 타일에 어울리는 케라폭시 112번 미디엄 그레이로 정밀 시공한 사례입니다.",
    excerpt: "구멍 난 줄눈과 덜그럭거리는 타일을 정밀 보수하고 케라폭시 112번으로 완성한 동탄 금강 펜테리움 화장실 줄눈시공 사례입니다.",
    body: {
      beforeText: "동탄 금강 펜테리움 고객님 댁의 화장실은 기존 백시멘트 줄눈 곳곳에 구멍이 뚫려 물이 스며들기 쉬운 상태였습니다. 또한, 일부 타일이 발로 밟을 때마다 덜그럭거리며 흔들리는 유격 현상이 있어 줄눈 탈락의 위험이 매우 높았습니다.",
      afterText: "그레이톤 타일과 가장 자연스럽게 어우러지는 케라폭시 112번 미디엄 그레이 색상을 선택하여 일체감 있고 차분한 욕실 분위기를 연출했습니다. 흔들리던 타일을 튼튼하게 고정하는 기초 보수 작업을 선행한 후 정밀하게 충진하여 고객님께서 매우 만족해하셨습니다. 디테일라인은 시공 후 2년 무상 A/S를 보장합니다.",
    },
    story: [
      { heading: "현장의 핵심 문제: 구멍 뚫린 기존 줄눈과 흔들리는 타일", text: "안녕하세요. 정직하고 바른 시공을 지향하는 타일 줄눈시공 전문업체 디테일라인입니다.\n\n오늘 소개해 드릴 현장은 동탄에 위치한 금강 펜테리움 아파트 34평형의 화장실 줄눈시공 사례입니다. 화장실은 매일 물을 사용하고 습기에 노출되는 공간인 만큼, 줄눈의 상태가 조금만 불량해도 내부로 물이 침투하여 심각한 하자로 이어질 수 있습니다.\n\n이번 현장의 고객님께서는 기존 화장실 줄눈에 구멍이 생기고, 일부 타일이 제대로 고정되지 않아 덜그럭거리는 증상을 겪으시던 중 저희 디테일라인에 시공을 의뢰해 주셨습니다. 타일의 상태가 불안정하면 일반적인 줄눈 주입만으로는 하자를 해결하기 어렵기 때문에, 한층 더 세심한 진단과 밑작업이 요구되었던 현장입니다.\n\n현장에 방문하여 화장실 바닥 상태를 점검했을 때, 가장 먼저 눈에 띈 것은 줄눈 곳곳에 뚫려 있는 구멍들이었습니다. 백시멘트 혹은 기존에 시공되어 있던 줄눈재가 탈락하면서 생긴 구멍들은 단순히 미관상 보기 좋지 않을 뿐만 아니라, 샤워할 때 흘러나오는 물이 타일 아래쪽으로 고스란히 스며드는 통로가 되고 있었습니다.\n\n더 큰 문제는 일부 타일이 발로 밟거나 손으로 눌렀을 때 덜그럭거리며 흔들리는 현상이었습니다. 타일 아래의 접착제가 깨졌거나 비어 있는 상태에서 줄눈만 새로 채워 넣으면, 타일의 미세한 움직임으로 인해 새로 시공한 줄눈까지 금방 깨지거나 탈락할 위험이 매우 높습니다. 따라서 시공 전에 타일의 유격 상태를 꼼꼼히 체크하는 과정이 선행되었습니다." },
      { heading: "디테일라인의 밑작업: 정밀한 수작업과 안정화 공정", text: "줄눈시공의 수명은 수명 그 자체보다 밑작업의 깊이와 정밀도에 의해 결정됩니다. 특히 이번 동탄 금강 펜테리움 현장처럼 타일이 덜그럭거리는 곳에서는 더욱 정밀한 손길이 필요합니다.\n\n첫째로, 구멍이 나고 헐거워진 기존의 줄눈재를 전용 도구를 사용해 타일 측면이 깨끗하게 드러날 때까지 깊고 바르게 파내었습니다. 이 과정에서 타일 모서리가 깨지지 않도록 숙련된 기술로 정밀하게 작업했습니다.\n\n둘째로, 덜그럭거리는 타일의 유격을 그대로 둔 채 줄눈을 주입하면 하자율이 치솟기 때문에, 줄눈재 주입 전에 타일을 고정하는 기초 보수 작업을 병행하였습니다.\n\n셋째로, 파낸 시멘트 가루와 이물질이 조금이라도 남아 있으면 줄눈재의 접착력이 떨어집니다. 고성능 청소기를 이용해 미세한 먼지까지 완벽히 흡입한 후, 유분기를 제거하는 알코올 세척 과정을 거쳤습니다." },
      { heading: "타일과의 조화를 고려한 색상 결정: 그레이톤 타일과 112번의 매칭", text: "고객님 댁의 화장실 타일은 모던하고 차분한 느낌을 주는 그레이톤이었습니다. 타일 줄눈은 타일과 별개로 도드라지는 것보다, 타일과 자연스럽게 한 몸처럼 어우러질 때 공간이 훨씬 더 넓어 보이고 정돈된 느낌을 줍니다.\n\n저희 디테일라인은 고객님과의 상담을 통해 그레이톤 타일에 가장 일체감이 뛰어난 케라폭시 112번 미디엄 그레이 색상을 추천해 드렸습니다. 지나치게 밝지도 어둡지도 않은 중도 제색 계열의 112번 색상은 타일의 톤을 차분하게 잡아주면서도, 오염이 타더라도 쉽게 티가 나지 않아 관리가 매우 용이하다는 장점이 있습니다." },
      { heading: "솔직하게 말씀드리는 부분", text: "디테일라인은 시공의 장점만을 늘어놓아 눈을 가리지 않습니다. 이번 현장과 관련하여 고객님께서 반드시 인지하셔야 할 정직한 사실을 전해드립니다.\n\n우선 타일 흔들림의 근본적인 한계가 존재합니다. 저희가 줄눈 주입 전 기초 작업을 통해 덜그럭거리는 타일을 최대한 고정하고 줄눈을 충진하였으나, 이는 줄눈시공 범주 내에서의 보수 작업입니다. 만약 타일 배면의 모르타르가 완전히 깨져 벽체나 바닥 콘크리트로부터 완전히 박리된 상태라면, 줄눈재가 타일을 잡아주는 힘만으로는 시간이 흐른 뒤 다시 미세한 유격이 발생할 수 있습니다. 향후 타일 자체의 침하가 더 진행될 경우, 이는 줄눈의 하자가 아닌 타일 자체의 재시공이 필요한 영역임을 정직하게 안내해 드립니다.\n\n또한 줄눈재의 양생 시간 보장이 필수적입니다. 시공 후 완벽한 경화가 이루어지기 전까지는 물 사용을 엄격히 제한해 주셔야 줄눈재가 타일 측면에 단단히 흡착됩니다. 완전 양생 전에 수분에 노출될 경우 접착력이 저하될 수 있으므로 주의가 필요합니다." },
      { heading: "시공을 마치며", text: "시공이 모두 완료된 후, 구멍이 숭숭 뚫려 지저분해 보였던 바닥은 112번 그레이톤 줄눈을 통해 물 흐르듯 깔끔한 선으로 채워졌습니다. 덜그럭거리며 불안감을 주었던 타일 부위 역시 단단히 고정되어 한결 안정적인 보행감을 선사하게 되었습니다.\n\n현장을 직접 확인하신 고객님께서는 기존에 스트레스를 받으셨던 줄눈 구멍과 타일 흔들림 문제가 말끔히 해결된 모습을 보시고 매우 만족해하셨습니다. 거듭 너무 만족스럽다는 말씀을 전해주신 덕분에 저희 역시 큰 보람을 느끼며 기분 좋게 현장을 마무리할 수 있었습니다.\n\n디테일라인은 언제나 눈에 보이는 화려함보다, 타일 틈새 깊은 곳의 기초를 먼저 생각합니다. 정직한 시공이 만들어내는 디테일의 차이를 경험해 보세요." },
    ],
